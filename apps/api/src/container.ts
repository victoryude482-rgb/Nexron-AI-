...
export function getRuntime(){if(runtime)return runtime;const router=new AIRouter(providersFromEnv(process.env));runtime=new AgentRuntime(router,new LLMTaskPlanner(router),undefined,undefined,leadService());return runtime;}
